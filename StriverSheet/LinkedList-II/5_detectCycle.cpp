...
int main()
{
    ...
    // head = AppendLinkedList(0, head);
    // head = AppendLinkedList(4, head);
    printList(head);
    LN *getpremid = getPremid(head);
    cout << "pre mid : " << getpremid->val << endl;
    LN *last = getLast(head);
    cout << "last : " << last->val << endl;
    last->next = getpremid;
    cout << "Cycle found at element : " << detectCycle(head)->val << endl;
