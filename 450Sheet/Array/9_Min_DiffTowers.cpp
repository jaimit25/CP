...
public:
	...
	int getMinDiff(int *arr, int n, int k)
	{
		...
		// ie..  3 9 6 12 20 will give maximum diff as 20-3 = 17 ,Also array is sorted so this is the maximum difference but if k = 3 then (3+3= 6 and 20+3 = 23) and 17-0=17 or 23 - 6 = 0 ...there can be many diff ideas
